function BullePersonne(param) {
    ...
    bulleContainer.style.overflow="hidden";
  ...
  */
  ...
  //  bulleContainer.appendChild(text);
    ...
    img.src = "Assets/Nous/"+param.image;
    img.style.height="100%";

    bulleContainer.appendChild(img);
    ...
    this.goToInit = function(){
        ...
        param.position = {x:param.positionInit.x,y:4/2};
